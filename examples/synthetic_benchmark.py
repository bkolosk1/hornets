    ...
    for num_features in nft:
            for iteration in trange(reps):
                for problem in probs:
                    X, y = generate_synthetic_data(num_features, num_instances, operation=problem)
                    ...
                    print("Num Features", num_features, "Num Instances", num_instances, "Problem", problem, ":", acc)
